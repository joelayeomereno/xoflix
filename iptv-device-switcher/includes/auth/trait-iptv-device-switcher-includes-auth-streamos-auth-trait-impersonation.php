...
/**
 * Module: iptv-device-switcher/includes/auth/trait-iptv-device-switcher-includes-auth-streamos-auth-trait-impersonation.php
 * Extracted from StreamOS_Auth (no logic changes).
 */
trait StreamOS_Auth_Trait_Impersonation {
