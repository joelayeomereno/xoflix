...
<style>
    ...
    /* Correct disabled state for links */
    .tv-btn.disabled{opacity:0.5;pointer-events:none;background:#f1f5f9;cursor:default;}
...
<div class="tv-sub-details-wrap">
    <div class="tv-card">
        ...
        <div class="tv-pager">
            <?php if($has_prev): ?>
                <a class="tv-btn" href="<?php echo esc_url($mk_url($current_page - 1)); ?>">
                    &larr; Previous
                </a>
            <?php else: ?>
                <span class="tv-btn disabled">&larr; Previous</span>
            <?php endif; ?>
            ...
            <?php else: ?>
                <span class="tv-btn disabled">Next &rarr;</span>
            <?php endif; ?>
        </div>
    </div>
</div>